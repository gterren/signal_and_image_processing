...
def _atmospheric_effect_v11(_tools, I_, x_sun_, m_, i_sun_max, tau):
    ...
    def __F(I_, w_):
        ...
        ax.set_title(r'$\mathcal{S} (j; y_{0}, \theta_1, \theta_2) $', fontsize = 25)
        ...
        ax.set_zlabel(r'Temp. $[K]$', fontsize = 15, labelpad = 10)
        ...
        fig = plt.figure(figsize = (7.5, 5))
        ax = fig.gca(projection = '3d')
        ax.set_title(r'$\mathcal{D} (i,j; \mathbf{x}_{0}, \theta_3, \theta_4) $',
        fontsize = 25)
