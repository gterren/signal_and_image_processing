...
name = 'atmospheric_model_parameters_fitting_dataset_v2-2.pkl'
...
# 0 - 1 - 2
# 0 - 18.686060504543182 - 0.6989586969400491 - 0.017774163953075843
# 1 - 24.477469439668322 - 0.8936476710450239 - 0.019005304435305626
# 2 - 24.24107445042736 - 0.8795168233793134 - 0.019462037598669317
# 3 - 24.23558701430996 - 0.8947658384898889 - 0.019408239704472894
# 4 - - -
# 5 - 29.08022080085931 - 0.8896469895344289 - 0.019106740977068232
# 6 - 24.304313259702358 - 0.8895243759448463 - 0.01843304866397188
# 7 - 24.594378905393683 - 0.894529830993472 - 0.019288580043850707
...
#cov_index_ = [[0], [0, 3], [0, 3, 2], [0, 3, 2, 6], [0, 3, 2, 6, 1], [0, 3, 2, 6, 1, 7], [0, 3, 2, 6, 1, 7, 5]][idx]
#reg_index_ = [0]
# cov_index_ = [[0], [0, 2], [0, 2, 6], [0, 2, 6, 5], [0, 2, 6, 5, 1], [0, 2, 6, 5, 1, 3], [0, 2, 6, 5, 1, 3, 7]][idx]
# reg_index_ = [1]
cov_index_ = [[0], [0, 6], [0, 6, 1], [0, 6, 1, 5], [0, 6, 1, 5, 7], [0, 6, 1, 5, 7, 3], [0, 6, 1, 5, 7, 3, 2]][idx]
reg_index_ = [2]
N_alphas  = 41
N_degrees = 7
...
for idx_degree_ in range(N_degrees):
    ...
    # Test scores
    print('R Ts.: ', np.mean(r2_ts_, axis = 0), alpha, degree)
