# Order 2 Polynomial Model + Lorentz function optimized together
...
bounds_ = [(-1e3, 1e3), (-1e3, 1e3), (1e5, 1e6), (.1, 1.)]
# loop over days
for i in range(len(X_)):
    ...
    try:
        ...
        pass
    # save the Dataset
    name = r'atmospheric_model_parameters_dataset_v2-1.pkl'
    file = path.format(name)
    print(file)
